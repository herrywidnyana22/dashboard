...
import { Pointer } from '@syncfusion/ej2/circulargauge'
    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0 '>
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:bg-main-dark-bg w-400">
        <div className="flex justify-between items-center p-4 ml-4">
          ...
          <button type='button' onClick={() =>{setThemeSettings(false)}} style={{color: 'rgb(153, 171, 180)', borderRadius: '50%'}} className="text-xl p-3 hover:drop-shadow-xl ">
            <MdOutlineCancel/>
          </button>
        </div>
